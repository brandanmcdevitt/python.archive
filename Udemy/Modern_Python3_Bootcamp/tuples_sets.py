...
# 1. Create a variable which is a tuple with the the values 1, 2, 3 and 4 inside.
numbers = (1,2,3,4)
...
print(set1 | set2) # set union between set1 and set2
print(set1.intersection(set2)) # set intersection between set1 and set2